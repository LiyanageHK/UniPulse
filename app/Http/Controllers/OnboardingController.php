    ...
    public function storeStep1(Request $request)
{
    ...
    public function storeStep2(Request $request)
    {
        ...
        StudentProfile::create([
                ...
                'al_result_subject1' => $alResults['subject_1']['grade'] ?? null,
                'al_result_subject2' => $alResults['subject_2']['grade'] ?? null,
                'al_result_subject3' => $alResults['subject_3']['grade'] ?? null,
                'al_result_english' => $alResults['subject_4']['grade'] ?? null,
                'al_result_gk' => $alResults['subject_5']['grade'] ?? null,
