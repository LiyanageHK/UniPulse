...
class MemoryExtractionService
{
    ...
    public function extractMemoriesFromMessage(Message $message): array
    {
        ...
        $extractionPrompt = $this->buildExtractionPrompt($recentMessages);
     ...
     */
    protected function buildExtractionPrompt(array $conversationContext): string
    {
        $conversationText = '';
...
4. Importance scoring:
   - 0.9-1.0: Critical identity/goal information (major, career goal, serious health concern)
