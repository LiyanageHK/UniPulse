<x-app-layout title="View Profile - UniPulse">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white shadow rounded-xl p-8 border border-gray-100">
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    @foreach (is_array($user->profile->communication_methods) ? $user->profile->communication_methods : (json_decode($user->profile->communication_methods, true) ?: []) as $method)
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    @foreach (is_array($user->profile->top_interests) ? $user->profile->top_interests : (json_decode($user->profile->top_interests, true) ?: []) as $interest)
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    @foreach (is_array($user->profile->hobbies) ? $user->profile->hobbies : (json_decode($user->profile->hobbies, true) ?: []) as $hobby)
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    @foreach (is_array($user->profile->support_types) ? $user->profile->support_types : (json_decode($user->profile->support_types, true) ?: []) as $support)
