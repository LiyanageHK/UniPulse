...
<body class="bg-gray-50 text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <!-- Hero -->
        <section class="bg-white rounded-xl shadow-sm p-8 mb-10 fade-up" data-animate>
            <div class="md:flex md:items-center md:gap-10">
                <div class="md:flex-1">
                    <h1 class="text-3xl md:text-4xl font-extrabold text-blue-700 mb-4">About UniPulse</h1>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="{{ url('/') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md font-semibold shadow-sm hover:bg-blue-700">Get Started</a>
                    </div>
                </div>
